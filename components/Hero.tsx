        ...
        <section>
          <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
            <div className="relative z-10 mx-auto max-w-4xl text-center">
              ...
              >
                An Ayurvedic approach crafted to naturally support fat-control
                and lean muscle development. Contains traditional herbs known
                for helping balance metabolism and promoting overall strength.
              </TextEffect>
